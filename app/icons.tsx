...
export function LineIcon({ name }: { name: IconName }) {
  ...
  switch (name) {
    ...
    case "question": drawing = <><path d="M7 3.5h10a3.5 3.5 0 0 1 3.5 3.5v7a3.5 3.5 0 0 1-3.5 3.5h-5.2L6.5 21v-3.7A3.5 3.5 0 0 1 3.5 14V7A3.5 3.5 0 0 1 7 3.5Z"/><path d="M10.2 9.5a2 2 0 1 1 3 1.7c-.75.45-1.2.9-1.2 1.75M12 15.25v.15"/></>; break;
