...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-copy reveal visible"><p className="eyebrow"><span /> Информационно-партнёрский сервис</p><h1>Материнский капитал — <em>возможностей больше,</em> чем кажется</h1><p className="hero-lead">Для разных ситуаций — разные решения. Поможем разобраться в доступных вариантах и подобрать подходящий именно вам.</p><button className="button button-primary" onClick={openSituation}>Узнать свои возможности<ArrowIcon /></button><div className="trust-row"><span><LineIcon name="check" />Бесплатно</span><span><LineIcon name="check" />Конфиденциально</span><span><LineIcon name="check" />По всей России</span></div></div><div className="hero-visual reveal visible" aria-label="Персональный подбор возможностей"><div className="orb orb-one" /><div className="orb orb-two" /><div className="visual-card card-main"><p>Ваша ситуация</p><strong>Подберём подходящий вариант</strong><div className="progress"><i /></div><small>Учтём цели и доступную сумму</small></div><div className="visual-card card-note"><b>01</b><span>Расскажите о ситуации</span></div><div className="visual-card card-result"><b><LineIcon name="check" /></b><span>Понятные условия</span></div></div></section>
